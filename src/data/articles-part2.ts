export const articlesPart2: Record<string, { title: string; metaDescription: string; content: string }> = {
  ...
  "gratuiti-vs-plati-care-alegi": {
    ...
    content: `<article>
      ...
      <p>Cauți <strong>instrumente de inteligență artificială gratuite</strong>? În 2026, piața instrumentelor AI oferă opțiuni gratuite impresionante pentru aproape orice nevoie. Iată un ghid complet cu cele mai bune opțiuni gratuite și când merită să investești în versiuni premium.</p>
      ...
      <ul>
        ...
        <li><strong>Play.ht (Free):</strong> Text-to-speech cu credite limitate</li>
      </ul>
